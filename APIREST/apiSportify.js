...
connection.connect(function(err){
    if(err){
        ...
        console.log('Conexion completed');
    }
});
...
app.post(`/users/register`, function(request, response) {
    ...
    connection.query(sql1, params1, function (err, res) {  
        if(err){
            ...
            let params = [request.body.name, request.body.lastName, 
                request.body.password, request.body.rol, 
...
app.put(`/users`, function(request, response) {
    let params = [request.body.name, request.body.lastName, 
        request.body.password, request.body.rol, request.body.email, 
        request.body.phone, request.body.user_id];
...
app.put(`/training`, function(request, response) {
    let params = [request.body.name, request.body.date, request.body.location, 
        request.body.description, request.body.training_id]
...
app.put(`/match`, function(request, response) {
    let params = [request.body.date, request.body.comments, request.body.rival, 
        request.body.location, request.body.match_id];
...
app.put(`/exercise`, function(request, response) {
    let params = [request.body.name, request.body.description, request.body.url, 
        request.body.type, request.body.exercise_id]
